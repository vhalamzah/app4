...
<main role="main" class="col-md-9 d-content ml-sm-auto col-lg-10 pt-3 px-4">
    ...
    <a class="btn addBtn btn-sm btn-primary" href="{{route('permissions.index')}}">Back</a>
    
    <form method="post" action="{{ route('permissions.store') }}" data-parsley-validate class="form-horizontal form-label-left">
